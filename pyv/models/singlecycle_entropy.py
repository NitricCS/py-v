...
from pyv.stages_entropy import EXMEM_t, IFStage, IFID_t, IDStage, EXStage, MEMStage, \
    WBStage, BranchUnit
...
class SingleCycleEntropy(Module):
...
class SingleCycleEntropyModel(Model):
    """Model wrapper for SingleCycle."""

    def __init__(self):
        self.core = SingleCycleEntropy()
        """Module instance"""
